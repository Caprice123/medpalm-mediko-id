...
export default {
    ...
    admin: {
        ...
        diagnosticNodesV2: "/admin/v2/diagnostic/nodes",
        diagnosticQuizV2: "/admin/v2/diagnostic/quiz",
        anatomy: "/admin/v1/anatomy",
        anatomyV2: "/admin/v2/atlas-quiz/anatomy",
        atlas: "/admin/v1/atlas",
        atlasV2: "/admin/v2/atlas-quiz/atlas",
        atlasModelsUnlinked: "/admin/v2/atlas-quiz/atlas-models/unlinked",
        atlasModelRelations: (uniqueId) => `/admin/v2/atlas-quiz/atlas-models/${uniqueId}/relations`,
        atlasModelQuizRelations: (uniqueId) => `/admin/v2/atlas-quiz/atlas-models/${uniqueId}/quiz-relations`,
        anatomyQuizzesUnlinked: "/admin/v2/atlas-quiz/anatomy-quizzes/unlinked",
        anatomyQuizRelations: (uniqueId) => `/admin/v2/atlas-quiz/anatomy-quizzes/${uniqueId}/relations`,
        anatomyQuizAtlasRelations: (uniqueId) => `/admin/v2/atlas-quiz/anatomy-quizzes/${uniqueId}/atlas-relations`,
        ...
        featureNodesV2: "/admin/v2/feature-nodes",
        featureNodeRecords: "/admin/v1/feature-nodes/records",
flashcardsV2: "/admin/v2/flashcard/decks",
        ...
        contentRelationsV2: "/admin/v2/content-relations",
    },
    api: {
        ...
        featureNodeStats: (id) => `/api/v1/feature-nodes/${id}/stats`,
        featureNodePreview: (id) => `/api/v1/feature-nodes/${id}/preview`,
        featureNodeTopicAtlasModels: (id) => `/api/v1/feature-nodes/${id}/topic-atlas-models`,
        featureNodeBatchStats: '/api/v1/feature-nodes/batch-stats',
        contentRelationsV2: "/api/v2/content-relations",
        mcqNodes: "/api/v2/mcq",
        exercises: "/api/v1/exercises",
        diagnostic: "/api/v1/diagnostic",
        diagnosticNodes: "/api/v2/diagnostic",
        anatomy: "/api/v1/anatomy",
        atlas: "/api/v1/atlas",
        features: "/api/v1/features",
        featuresV2: "/api/v2/features",
        atlasQuizTopics: "/api/v2/atlas-quiz/topics",
        atlasQuizTopic: (slug) => `/api/v2/atlas-quiz/${slug}`,
        atlasQuizTopicAtlasModels: (slug) => `/api/v2/atlas-quiz/${slug}/atlas-models`,
        atlasQuizTopicModuleOptions: (slug) => `/api/v2/atlas-quiz/${slug}/module-options`,
        atlasQuizTopicAnatomyQuizzes: (slug) => `/api/v2/atlas-quiz/${slug}/anatomy-quizzes`,
        atlasQuizAtlasModelDetail: (slug, uniqueId) => `/api/v2/atlas-quiz/${slug}/atlas-models/${uniqueId}`,
        userContentRelations: '/api/v2/content-relations',
        atlasQuizAnatomyQuizDetail: (slug, uniqueId) => `/api/v2/atlas-quiz/${slug}/anatomy-quizzes/${uniqueId}`,
        summaryNotes: "/api/v1/summary-notes",
        summaryNotesV2: "/api/v2/summary-notes",
        summaryNotesV2Topics: "/api/v2/summary-notes/topics",
        summaryNotesV2Subtopics: (topicId) => `/api/v2/summary-notes/topics/${topicId}/subtopics`,
