...
export const hasFeaturePermission = (feature) => {
  ...
  if (user.role === 'admin') {
    const defaultFeatures = ['exercise', 'flashcard', 'calculator', 'diagnostic', 'anatomy', 'mcq', 'chatbot', 'skripsi', 'oscePractice', 'summaryNotes', 'featureNodes']
...
export const getUserFeatures = () => {
  ...
  const allFeatures = ['exercise', 'flashcard', 'calculator', 'diagnostic', 'anatomy', 'mcq', 'chatbot', 'skripsi', 'oscePractice', 'summaryNotes', 'featureNodes']
  ...
  // Default permissions for admin role
  if (user.role === 'admin') {
    return ['exercise', 'flashcard', 'calculator', 'diagnostic', 'anatomy', 'mcq', 'chatbot', 'skripsi', 'oscePractice', 'summaryNotes', 'featureNodes']
  }
