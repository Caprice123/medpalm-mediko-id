...
export const useFeatureSetting = (onClose) => {
  ...
  const form = useFormik({
    initialValues: {
      ...
      chatbot_validated_prompt: 'Kamu harus HANYA menggunakan informasi dari summary notes yang diberikan sebagai konteks. Selalu sertakan sitasi [1], [2] dll untuk sumber yang kamu gunakan. Jika informasi tidak ada di konteks, katakan bahwa kamu tidak memiliki informasi tersebut.',
      ...
      chatbot_research_prompt: 'Berikan jawaban berbasis riset medis dengan sitasi dari sumber terpercaya. Prioritaskan jurnal ilmiah dan guidelines medis terbaru.',
