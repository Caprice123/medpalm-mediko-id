...
export const useFeatureSetting = (onClose) => {
  ...
  const form = useFormik({
    initialValues: {
      ...
      // AI Researcher - Query Reformulation (Perplexity only)
      skripsi_ai_researcher_reformulation_model: 'gemini-2.0-flash-exp',
      skripsi_ai_researcher_reformulation_prompt: '',
      skripsi_ai_researcher_system_prompt: '',
      skripsi_ai_researcher_citations_count: '10',
      ...
      skripsi_validated_embedding_model: 'text-embedding-004',
      skripsi_validated_cost: '0',
      skripsi_validated_context_messages: '10',
      skripsi_validated_system_prompt: '',
      skripsi_validated_prompt: '',
      skripsi_validated_search_count: '5',
      skripsi_validated_threshold: '0.3',
      skripsi_validated_rewrite_enabled: true,
    ...
    onSubmit: async (values) => {
      try {
        ...
        const constantsToSave = {
          ...
          skripsi_validated_enabled: String(values.skripsi_validated_enabled),
          skripsi_validated_rewrite_enabled: String(values.skripsi_validated_rewrite_enabled),
  ...
  useEffect(() => {
    const onLoad = async () => {
      // Only fetch constants if user has 'skripsi' permission
      if (!hasFeaturePermission('skripsi')) {
        console.warn('User lacks permission to fetch skripsi constants')
        return
      }
      ...
      const keys = [
        ...
        'skripsi_ai_researcher_updated_after',
        'skripsi_ai_researcher_updated_before',
        'skripsi_ai_researcher_reformulation_model',
        'skripsi_ai_researcher_reformulation_prompt',
        'skripsi_ai_researcher_system_prompt',
        ...
        'skripsi_validated_context_messages',
        'skripsi_validated_system_prompt',
        'skripsi_validated_prompt',
      ...
      try {
        ...
        const formattedConstants = {
          ...
          skripsi_validated_enabled: constants.skripsi_validated_enabled === 'true',
          skripsi_validated_rewrite_enabled: constants.skripsi_validated_rewrite_enabled === 'true',
