        ...
        footer={
          <>
            ...
            <Button
              ...
              disabled={loading.isCreateDiagnosticQuizLoading || loading.isUpdateDiagnosticQuizLoading}
            >
              {(loading.isCreateDiagnosticQuizLoading || loading.isUpdateDiagnosticQuizLoading)
                ? 'Creating...'
                : 'Create Quiz'}
            </Button>
          </>
