...
import {
    fetchAdminDiagnosticQuizzes,
    updateDiagnosticQuiz,
} from '@store/diagnostic/adminAction'
...
export const useUpdateQuiz = (closeCallback) => {
  ...
  const { detail: selectedQuiz } = useSelector(state => state.diagnostic)
  ...
  const form = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      dispatch(updateDiagnosticQuiz(selectedQuiz.uniqueId, quizData, onSuccess))
    }
  })
