...
import { useUpdateCalculator } from '../../hooks/subhooks/useUpdateCalculator'
import {
  FormSection,
  Label,
  ErrorText,
...
const UpdateCalculatorModal = ({ calculator, onClose }) => {
  ...
  const {
    ...
    handleConfirmClose,
    handleCancelClose
  } = useUpdateCalculator(calculator, onClose)
        ...
        footer={
          <>
            ...
            <Button
              ...
              disabled={loading.isUpdateCalculatorLoading}
            >
              {loading.isUpdateCalculatorLoading ? 'Menyimpan...' : 'Update Kalkulator'}
            </Button>
          </>
        }
      >
...
export default UpdateCalculatorModal
