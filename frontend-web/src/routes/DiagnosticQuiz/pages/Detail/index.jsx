                            ...
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
                                <QuizMainContent>
                                    ...
                                    <QuestionsContainer>
                                        ...
                                        <QuestionsSection>
                                            {currentQuiz.diagnostic_questions?.map((question) => (
                                                <QuestionItem
                                                    key={question.id}
                                                    question={question}
                                        ...
                                        <SubmitButtonContainer>
                                            <Button
                                                variant="primary"
                                                type="submit"
                                                disabled={loading.isSubmitDiagnosticQuizLoading}
                                                style={{ width: '100%', padding: '1rem', fontSize: '1rem', fontWeight: 600 }}
                                            >
                                                {loading.isSubmitDiagnosticQuizLoading ? 'Mengirim...' : 'Kirim Jawaban'}
                                            </Button>
                                        </SubmitButtonContainer>
                                    </QuestionsContainer>
                                </QuizMainContent>
...
export default DiagnosticQuizDetail
