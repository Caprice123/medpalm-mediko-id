...
function ModeSelector({ currentMode, onModeChange }) {
  ...
  const availableModes = useSelector(state => state.skripsi.availableModes, shallowEqual)
  const costs = useSelector(state => state.skripsi.costs, shallowEqual)
  const userInformation = useSelector(state => state.skripsi.userInformation, shallowEqual)
