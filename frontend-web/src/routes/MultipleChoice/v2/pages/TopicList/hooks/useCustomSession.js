...
export function useCustomSession(onClose) {
  ...
  const [sectionList, setSectionList] = useState([{ id: 1, topicId: null, subtopicId: null, count: 5 }])
  ...
  const addSection = () =>
    setSectionList(prev => [...prev, { id: Date.now(), topicId: null, subtopicId: null, count: 5 }])
