...
class OsceController {
  ...
  async listTopics(req, res) {
    try {
      ...
      console.error('[OsceController.listTopics] Error:', error)
      return res.status(500).json({
        success: false,
        message: error.message || 'Failed to fetch OSCE topics',
      })
    }
  }
  ...
  async listSessions(req, res) {
    try {
      ...
      console.error('[OsceController.listSessions] Error:', error)
      return res.status(500).json({
        success: false,
        message: error.message || 'Failed to fetch OSCE sessions',
      })
    }
  }
  ...
  async startSession(req, res) {
    try {
      ...
      return res.status(500).json({
        success: false,
        message: error.message || 'Failed to start OSCE session',
      })
    }
  }
  ...
  async getSession(req, res) {
    try {
      ...
      console.error('[OsceController.getSession] Error:', error);
      return res.status(500).json({
        success: false,
  ...
  async getMessages(req, res) {
    try {
      ...
      console.error('[OsceController.getMessages] Error:', error)
      return res.status(500).json({
        success: false,
  ...
  async getDiagnoses(req, res) {
    try {
      ...
      console.error('[OsceController.getDiagnoses] Error:', error)
      return res.status(500).json({
        success: false,
  ...
  async saveDiagnoses(req, res) {
    try {
      ...
      console.error('[OsceController.saveDiagnoses] Error:', error)
      return res.status(500).json({
        success: false,
  ...
  async getTherapies(req, res) {
    try {
      ...
      console.error('[OsceController.getTherapies] Error:', error)
      return res.status(500).json({
        success: false,
  ...
  async saveTherapies(req, res) {
    try {
      ...
      console.error('[OsceController.saveTherapies] Error:', error)
      return res.status(500).json({
        success: false,
  ...
  async endSession(req, res) {
    try {
      ...
      console.error('[OsceController.endSession] Error:', error)
      return res.status(500).json({
        success: false,
...
export default new OsceController();
