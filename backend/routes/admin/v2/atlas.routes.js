...
import atlasV2Controller from '#controllers/admin/v2/atlas.controller'
...
router.delete('/:uniqueId', asyncHandler(atlasV2Controller.delete.bind(atlasV2Controller)))
