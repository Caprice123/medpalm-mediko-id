...
import anatomyV2Controller from '#controllers/admin/v2/anatomy.controller'
...
router.delete('/:uniqueId', asyncHandler(anatomyV2Controller.delete.bind(anatomyV2Controller)))
