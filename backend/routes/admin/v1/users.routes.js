...
router.get('/:id/feature-subscriptions', asyncHandler(usersController.getFeatureSubscriptions.bind(usersController)))
router.put('/:id/feature-subscriptions', asyncHandler(usersController.updateFeatureSubscriptions.bind(usersController)))
