...
export class GetActiveFeaturesV2Service extends BaseService {
  static async call() {
    const getAccessDescription = (accessType, cost) => {
      switch (accessType) {
        case 'subscription': return 'Requires active subscription'
        case 'credits': return `Requires ${cost} credits per use`
        case 'subscription_and_credits': return `Requires subscription + ${cost} credits per use`
        case 'free': return 'Free to use'
        default: return cost > 0 ? `Requires ${cost} credits per use` : 'Free to use'
      }
    }
    ...
    if (featureConstants.summary_notes_feature_title) {
      ...
      features.push({
        ...
        cost, accessType, icon: '📝', sessionType: 'summary_notes',
        isActive: featureConstants.summary_notes_is_active,
        youtubeUrl: featureConstants.summary_notes_youtube_url || '',
      })
    }

    // Combined Anatomy & Atlas V2 feature
    if (featureConstants.anatomy_atlas_feature_title) {
      const cost = parseFloat(featureConstants.anatomy_atlas_credit_cost) || 0
      const accessType = featureConstants.anatomy_atlas_access_type || 'subscription'
      features.push({
        name: featureConstants.anatomy_atlas_feature_title,
        description: featureConstants.anatomy_atlas_feature_description,
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🧬', sessionType: 'anatomy_atlas',
        isActive: featureConstants.anatomy_atlas_is_active,
        youtubeUrl: featureConstants.anatomy_atlas_youtube_url || '',
      })
    }
    ...
    if (featureConstants.chatbot_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '💬', sessionType: 'chatbot',
    ...
    if (featureConstants.osce_practice_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🩺', sessionType: 'osce_practice',
    ...
    if (featureConstants.skripsi_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '📚', sessionType: 'skripsi_builder',
    ...
    if (featureConstants.mcq_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '📝', sessionType: featureConstants.mcq_session_type,
    ...
    if (featureConstants.diagnostic_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🩻', sessionType: 'diagnostic',
    ...
    if (featureConstants.flashcard_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🎴', sessionType: featureConstants.flashcard_session_type,
    ...
    if (featureConstants.exercise_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🎓', sessionType: featureConstants.exercise_session_type,
    ...
    if (featureConstants.calculator_feature_title) {
      ...
      features.push({
        ...
        accessDescription: getAccessDescription(accessType, cost),
        cost, accessType, icon: '🧮', sessionType: 'calculator',
