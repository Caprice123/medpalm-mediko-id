...
import constantRoutes from '#routes/api/v1/constant.routes';
...
import adminV2ContentRelationsRoutes from '#routes/admin/v2/contentRelations.routes';
import adminV2FeatureNodesRoutes from '#routes/admin/v2/featureNodes.routes';
...
import apiV2McqRoutes from '#routes/api/v2/mcq.routes';
import apiV2FeatureRoutes from '#routes/api/v2/feature.routes';
import apiV2AtlasQuizRoutes from '#routes/api/v2/atlasQuiz.routes';
import apiV2ContentRelationsRoutes from '#routes/api/v2/contentRelations.routes';
import recentlyViewedRoutes from '#routes/api/v1/recentlyViewed.routes';
import favoritesRoutes from '#routes/api/v1/favorites.routes';
...
app.use('/api/v2/features', apiV2FeatureRoutes);
app.use('/api/v2/atlas-quiz', apiV2AtlasQuizRoutes);
app.use('/api/v2/content-relations', apiV2ContentRelationsRoutes);
...
app.use('/admin/v2/flashcard/decks', adminV2FlashcardRoutes);
...
app.use('/admin/v2/atlas-quiz/atlas', adminV2AtlasRoutes);
app.use('/admin/v2/atlas-quiz/anatomy', adminV2AnatomyRoutes);
app.use('/admin/v2/atlas-quiz/atlas-models', adminV2AtlasModelsRoutes);
app.use('/admin/v2/atlas-quiz/anatomy-quizzes', adminV2AnatomyQuizzesRoutes);
app.use('/admin/v2/content-relations', adminV2ContentRelationsRoutes);
app.use('/admin/v2/feature-nodes', adminV2FeatureNodesRoutes);
